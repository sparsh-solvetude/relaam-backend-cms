...
export interface ApiAboutPageAboutPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    businesCard: Schema.Attribute.Component<'cards.media-card', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    businesTitle: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    >;
    lsDescription: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    managementCard: Schema.Attribute.Component<'cards.media-card', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    managementTitle: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    summaryBanner: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
...
export interface ApiBlogPageSlugBlogPageSlug
  extends Struct.CollectionTypeSchema {
  collectionName: 'blog_page_slugs';
  info: {
    displayName: 'Blog Page Slug';
    pluralName: 'blog-page-slugs';
    singularName: 'blog-page-slug';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    bannerCaption: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::blog-page-slug.blog-page-slug'
    >;
    publishedAt: Schema.Attribute.DateTime;
    seoTags: Schema.Attribute.Component<'seo.seo', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiBlogPageBlogPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    blogCards: Schema.Attribute.Component<'cards.plain-text-card', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    >;
    moreButtonText: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    titleWeb: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiCareerPageCareerPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    careerForm: Schema.Attribute.Component<'form.career-form', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    checkBoxText: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    cvFileSizeWarning: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    cvSelectButton: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    cvUploadText: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    formSubmitButton: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiContactPageContactPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    enquiriesButtonPhone: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiContractorsServicesPageContractorsServicesPage
  ...
  attributes: {
    ...
    csBanner2: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
...
export interface ApiHomePageHomePage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    featuredHeadingWeb: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    serviceHeadingMobile: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    serviceHeadingWeb: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiHomeSearchBarHomeSearchBar extends Struct.SingleTypeSchema {
  collectionName: 'home_search_bars';
  info: {
    displayName: 'Home SearchBar';
    pluralName: 'home-search-bars';
    singularName: 'home-search-bar';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    bedrooms: Schema.Attribute.Component<'drop-down.select-dropdown', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::home-search-bar.home-search-bar'
    >;
    locationDropDown: Schema.Attribute.Component<
    ...
    propertyType: Schema.Attribute.Component<
      'drop-down.select-dropdown',
      true
    > &
      Schema.Attribute.SetPluginOptions<{
...
export interface ApiPropertyManagementPagePropertyManagementPage
  ...
  attributes: {
    ...
    offeringSubTitleMobile: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    offeringSubTitleWeb: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiServicesPageServicesPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    focusHeadingWeb: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiSignatureProjectSignatureProject
  ...
  attributes: {
    ...
    overviewHeadingLineTwo: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiSiteMapSiteMap extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    >;
    pages: Schema.Attribute.Component<'table.site-map', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiSmartHubSmartHub extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    aboutHeading2: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    SHCard: Schema.Attribute.Component<'cards.plain-text-card', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    shDescription: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    shDescriptionVisit: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiTajdidFormTajdidForm extends Struct.SingleTypeSchema {
  collectionName: 'tajdid_forms';
  info: {
    displayName: 'Tajdid Form';
    pluralName: 'tajdid-forms';
    singularName: 'tajdid-form';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    dropdown: Schema.Attribute.Component<'drop-down.select-dropdown', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    publishedAt: Schema.Attribute.DateTime;
    tajdidForm: Schema.Attribute.Component<'form.career-form', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    textarea: Schema.Attribute.Component<'form.career-form', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiTajdidPageTajdidPage extends Struct.SingleTypeSchema {
  collectionName: 'tajdid_pages';
  info: {
    displayName: 'Tajdid Page';
    pluralName: 'tajdid-pages';
    singularName: 'tajdid-page';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    emaiLink: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiTenantPortalTenantPortal extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    submitRequestCard: Schema.Attribute.Component<
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::blog-page-slug.blog-page-slug': ApiBlogPageSlugBlogPageSlug;
      ...
      'api::home-search-bar.home-search-bar': ApiHomeSearchBarHomeSearchBar;
      ...
      'api::tajdid-form.tajdid-form': ApiTajdidFormTajdidForm;
      'api::tajdid-page.tajdid-page': ApiTajdidPageTajdidPage;
